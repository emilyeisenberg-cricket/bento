...
This is a fork of Bento which provides an [ARM64 version of Ubuntu 21.04 Hirsute Hippo packer file](packer_templates/ubuntu/ubuntu-21.04-arm64.json), which doesn't exist in the main Bento repo. It is just a copy of the Ubuntu 20.04 ARM64 packer template with the boot command from the Ubuntu 21.04 AMD64 packer template.

It is published on Vagrant Hub as `emilyeisenberg-cricket/ubuntu-21.04-arm64`.
